...
CREATE TABLE CALCULATOR ( ID NUMBER(8) NOT NULL, DISCRIMINATOR VARCHAR2(150 BYTE), BRAND VARCHAR2(50 BYTE) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
...
CREATE TABLE ORGANIZATION ( ID NUMBER(8) NOT NULL, DISCRIMINATOR VARCHAR2(150 BYTE), NAME VARCHAR2(50 BYTE), AGENCY_BUDGET NUMBER(8), CEO VARCHAR2(50 BYTE) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
...
CREATE TABLE SHOES ( ID NUMBER(8) NOT NULL, DISCRIMINATOR VARCHAR2(150 BYTE), COLOR VARCHAR2(50 BYTE), SPORTS_TYPE VARCHAR2(50 BYTE), DESIGNER_ID NUMBER(8) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
...
CREATE TABLE TANK_TANK_ACCESSORY ( TANK_ID NUMBER(8) NOT NULL, TANK_ACCESSORY_ID NUMBER(8) NOT NULL, TANK_DISCRIMINATOR VARCHAR2(150 BYTE) NOT NULL ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
...
CREATE TABLE CURRENCY ( ID NUMBER(8) NOT NULL, DISCRIMINATOR VARCHAR2(150 BYTE), COUNTRY VARCHAR2(50 BYTE), VALUE NUMBER(8) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
...
CREATE TABLE DESSERT ( ID NUMBER(8) NOT NULL, TOPPING VARCHAR2(50 BYTE), FILLING VARCHAR2(50 BYTE), DISCRIMINATOR VARCHAR2(150 BYTE) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
...
CREATE TABLE FISH ( ID NUMBER(8) NOT NULL, GENERA VARCHAR2(50 BYTE), PRIMARY_COLOR VARCHAR2(50 BYTE), FIN_SIZE NUMBER(8), DISCRIMINATOR VARCHAR2(150 BYTE), TANK_ID NUMBER(8), TANK_DISCRIMINATOR VARCHAR2(150 BYTE) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
...
CREATE TABLE GOVERMENT ( ID NUMBER(8) NOT NULL, DISCRIMINATOR VARCHAR2(150 BYTE), COUNTRY VARCHAR2(50 BYTE), PRIME_MINISTER VARCHAR2(150 BYTE), PRESIDENT VARCHAR2(50 BYTE), DEMOCRATIC_DISCRIMINATOR VARCHAR2(150 BYTE) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
...
CREATE TABLE LUGGAGE ( ID NUMBER(8) NOT NULL, DISCRIMINATOR VARCHAR2(150 BYTE), CAPACITY NUMBER(8), KEY_CODE NUMBER(8), EXPANDABLE VARCHAR2(1 BYTE), WHEEL_ID NUMBER(8) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
CREATE TABLE ABSTRACT_SPECIMEN ( ID NUMBER(8) NOT NULL, INITIAL_QTY NUMBER(8), LABEL VARCHAR2(50), LINEAGE VARCHAR2(50), PATHOLOGICAL_STATUS VARCHAR2(50), SPECIMEN_CLASS VARCHAR2(50), SPECIMEN_TYPE VARCHAR2(50)) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/

CREATE TABLE SUPER_TEST ( ID NUMBER(8) NOT NULL ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/

CREATE TABLE CHILD_TEST ( ID NUMBER(8) NOT NULL ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/

CREATE TABLE SITE ( ID NUMBER(8) NOT NULL, ACTIVITY_STATUS VARCHAR2(50), EMAIL_ADDRESS VARCHAR2(50), NAME VARCHAR2(50), TYPE VARCHAR2(10)) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/

CREATE TABLE SPECIMEN_COLLECTION_GROUP ( ID NUMBER(8) NOT NULL, NAME VARCHAR2(50), COMMENT_TEXT VARCHAR2(50) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/

CREATE TABLE SPECIMEN ( ID NUMBER(8) NOT NULL, ACTIVITY_STATUS VARCHAR2(50), AVAILABLE_QTY NUMBER(8), BARCODE VARCHAR2(50), COLLECTION_STATUS VARCHAR2(50), COMMENT_TEXT VARCHAR2(50), LABEL VARCHAR2(50), CREATED_ON DATE, IS_AVAILABLE NUMBER(8), SPECIMEN_COLLECTION_GROUP_ID NUMBER(8)) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/

CREATE TABLE MEMBER_O2OBS( id NUMBER(8) NOT NULL, name VARCHAR2(50), mentor_id NUMBER(8) DEFAULT NULL ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/

CREATE TABLE MEMBER_O2MUS( id NUMBER(8) NOT NULL, name VARCHAR2(50), mentor_id NUMBER(8) DEFAULT NULL ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/


CREATE TABLE MEMBER_O2MBS( id NUMBER(8) NOT NULL, name VARCHAR2(50), friend_id NUMBER(8) DEFAULT NULL ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/

CREATE TABLE MEMBER_O2OUS( id NUMBER(8) NOT NULL, name VARCHAR2(50), mentor_id NUMBER(8) DEFAULT NULL ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/

CREATE TABLE MEMBER_M2MBS (  id NUMBER(8) NOT NULL, name VARCHAR2(50) ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
CREATE TABLE MEMBER_M2MBS_JOIN ( MEMBER_ID NUMBER(8) NOT NULL, MENTOR_ID NUMBER(8) NOT NULL ) LOGGING NOCOMPRESS NOCACHE NOPARALLEL MONITORING
/
...
/
INSERT INTO MEMBER_O2OUS ( ID, NAME, MENTOR_ID ) VALUES ( 3, 'Name3', 1)
/
...
1,'ACTIVE',1, '123', 'STATUS', 'COMMENT', 'Specimen1',  TO_Date( '11/11/2011 12:00:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), 1, 1)
/
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (
2,'ACTIVE',2, '123', 'STATUS', 'COMMENT', 'Specimen1', TO_Date( '11/11/2011 12:00:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), 1, 1)
/
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (
3,'ACTIVE',3, '123', 'STATUS', 'COMMENT', 'Specimen1',  TO_Date( '11/11/2011 12:00:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), 1, 2)
/
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (
4,'ACTIVE',3, '123', 'STATUS', 'COMMENT', 'Specimen1',  TO_Date( '11/11/2011 12:00:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), 1, 2)
/
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (
5,'ACTIVE',10, '123', 'STATUS', 'COMMENT', 'Specimen1',  TO_Date( '11/11/2011 12:00:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), 1, 2)
/
...
, '123', 999, TO_Date( '05/15/2008 12:00:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), '999', 1, '1', 'abc', 'abc', '3', 3, 'cat')
/
...
ALTER TABLE SHOES ADD ( CONSTRAINT FK_SHOES_DESIGNER FOREIGN KEY (DESIGNER_ID) REFERENCES DESIGNER (ID) ON DELETE CASCADE)
/
...
ALTER TABLE HARD_DRIVE ADD ( CONSTRAINT FK_HARD_DRIVE_COMPUTER FOREIGN KEY (COMPUTER_ID) REFERENCES COMPUTER (ID) ON DELETE CASCADE)
/
...
ALTER TABLE SPECIMEN_COLLECTION_GROUP ADD ( CONSTRAINT PK_SPECIMEN_COLLECTION_GROUP PRIMARY KEY (ID))
/

ALTER TABLE ABSTRACT_SPECIMEN ADD ( CONSTRAINT PK_ABSTRACT_SPECIMEN PRIMARY KEY (ID))
/

ALTER TABLE SUPER_TEST ADD ( CONSTRAINT PK_SUPER_TEST PRIMARY KEY (ID))
/

ALTER TABLE CHILD_TEST ADD ( CONSTRAINT PK_CHILD_TEST PRIMARY KEY (ID))
/

ALTER TABLE SITE ADD ( CONSTRAINT PK_SITE PRIMARY KEY (ID))
/

ALTER TABLE SPECIMEN ADD ( CONSTRAINT FK_SPECIMEN_COLLECTION_GROUP FOREIGN KEY (SPECIMEN_COLLECTION_GROUP_ID) REFERENCES SPECIMEN_COLLECTION_GROUP (ID))
/

ALTER TABLE MEMBER_O2OBS ADD ( CONSTRAINT PK_MEMBER_O2OBS PRIMARY KEY (ID))
/
ALTER TABLE MEMBER_O2MUS ADD ( CONSTRAINT PK_MEMBER_O2MUS PRIMARY KEY (ID))
/
ALTER TABLE MEMBER_O2OBS ADD FOREIGN KEY (mentor_id) REFERENCES MEMBER_O2OBS(id)
/
ALTER TABLE MEMBER_O2MUS ADD FOREIGN KEY (mentor_id) REFERENCES MEMBER_O2MUS(id)
/
ALTER TABLE MEMBER_O2OBS ADD ( CONSTRAINT UQ_MEMBER_O2OBS_MENTOR_ID UNIQUE (MENTOR_ID))
/
ALTER TABLE MEMBER_O2MUS ADD ( CONSTRAINT UQ_MEMBER_O2MUS_MENTOR_ID UNIQUE (MENTOR_ID))
/
ALTER TABLE MEMBER_O2MBS ADD ( CONSTRAINT PK_MEMBER_O2MBS PRIMARY KEY (ID))
/
ALTER TABLE MEMBER_O2OUS ADD ( CONSTRAINT PK_MEMBER_O2OUS PRIMARY KEY (ID))
/
ALTER TABLE MEMBER_O2MBS ADD FOREIGN KEY (friend_id) REFERENCES MEMBER_O2MBS(id)
/
ALTER TABLE MEMBER_O2OUS ADD FOREIGN KEY (mentor_id) REFERENCES MEMBER_O2OUS(id)
/
ALTER TABLE MEMBER_M2MBS_JOIN ADD ( CONSTRAINT PK_MEMBER_JOIN PRIMARY KEY (MEMBER_ID, MENTOR_ID))
/
COMMIT
/