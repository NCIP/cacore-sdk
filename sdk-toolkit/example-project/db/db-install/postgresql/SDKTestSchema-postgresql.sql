...
DROP TABLE IF EXISTS ABSTRACT_SPECIMEN CASCADE;
CREATE TABLE ABSTRACT_SPECIMEN ( 
	ID integer NOT NULL, 
	INITIAL_QTY integer, 
	LABEL character varying(50), 
	LINEAGE character varying(50), 
	PATHOLOGICAL_STATUS character varying(50), 
	SPECIMEN_CLASS character varying(50), 
	SPECIMEN_TYPE character varying(50)
);


DROP TABLE IF EXISTS SUPER_TEST CASCADE;
CREATE TABLE SUPER_TEST ( 
	ID integer NOT NULL 
);


DROP TABLE IF EXISTS CHILD_TEST CASCADE;
...
DROP TABLE IF EXISTS SPECIMEN_COLLECTION_GROUP CASCADE;
CREATE TABLE SPECIMEN_COLLECTION_GROUP (
	ID integer NOT NULL, 
	NAME character varying(50), 
	COMMENT_TEXT character varying(50) 
);
...
CREATE TABLE SPECIMEN ( 
	...
	SPECIMEN_COLLECTION_GROUP_ID integer 
);

DROP TABLE IF EXISTS MEMBER_O2OBS CASCADE;
...
ALTER TABLE ONLY MEMBER_O2OBS ADD CONSTRAINT PK_MEMBER_O2OBS PRIMARY KEY (ID);


ALTER TABLE ONLY MEMBER_O2OBS
    ADD CONSTRAINT UQ_MEMBER_O2OBS_MENTOR_ID UNIQUE (MENTOR_ID);
...
ALTER TABLE ONLY MEMBER_O2MUS ADD CONSTRAINT PK_MEMBER_O2MUS PRIMARY KEY (ID);


ALTER TABLE ONLY MEMBER_O2MUS
    ADD CONSTRAINT UQ_MEMBER_O2MUS_MENTOR_ID UNIQUE (MENTOR_ID);


DROP TABLE IF EXISTS MEMBER_O2MBS CASCADE;
...
ALTER TABLE ONLY MEMBER_O2MBS ADD CONSTRAINT PK_MEMBER_O2MBS PRIMARY KEY (ID);
...
ALTER TABLE ONLY MEMBER_O2OUS ADD CONSTRAINT PK_MEMBER_O2OUS PRIMARY KEY (ID);


DROP TABLE IF EXISTS MEMBER_M2MBS CASCADE;
CREATE TABLE MEMBER_M2MBS (  
	id integer NOT NULL, 
	name character varying(50) 
);

DROP TABLE IF EXISTS MEMBER_M2MBS_JOIN CASCADE;
CREATE TABLE MEMBER_M2MBS_JOIN ( 
	MEMBER_ID integer NOT NULL, 
	MENTOR_ID integer NOT NULL 
);

CREATE UNIQUE INDEX PK_MEMBER_M2MBS ON EMPLOYEE (ID);

ALTER TABLE ONLY MEMBER_M2MBS_JOIN ADD CONSTRAINT PK_MEMBER_MENTOR PRIMARY KEY (MEMBER_ID, MENTOR_ID);

ALTER TABLE ONLY MEMBER_M2MBS_JOIN
    ADD CONSTRAINT UQ_MEMBER_M2MBS_JOIN UNIQUE (MEMBER_ID, MENTOR_ID);


INSERT INTO ABSTRACT_SPECIMEN (ID, INITIAL_QTY, LABEL, LINEAGE, PATHOLOGICAL_STATUS, SPECIMEN_CLASS, SPECIMEN_TYPE) VALUES (1,10,'Specimen1',null, null, 'Class1', 'Type1');
INSERT INTO ABSTRACT_SPECIMEN (ID, INITIAL_QTY, LABEL, LINEAGE, PATHOLOGICAL_STATUS, SPECIMEN_CLASS, SPECIMEN_TYPE) VALUES (2,10,'Specimen2',null, null, 'Class2', 'Type2');
INSERT INTO ABSTRACT_SPECIMEN (ID, INITIAL_QTY, LABEL, LINEAGE, PATHOLOGICAL_STATUS, SPECIMEN_CLASS, SPECIMEN_TYPE) VALUES (3,10,'Specimen3',null, null, 'Class3', 'Type3');
INSERT INTO ABSTRACT_SPECIMEN (ID, INITIAL_QTY, LABEL, LINEAGE, PATHOLOGICAL_STATUS, SPECIMEN_CLASS, SPECIMEN_TYPE) VALUES (4,10,'Specimen4',null, null, 'Class4', 'Type4');
INSERT INTO ABSTRACT_SPECIMEN (ID, INITIAL_QTY, LABEL, LINEAGE, PATHOLOGICAL_STATUS, SPECIMEN_CLASS, SPECIMEN_TYPE) VALUES (5,10,'Specimen5',null, null, 'Class5', 'Type5');

INSERT INTO SUPER_TEST (ID) VALUES (1);
INSERT INTO SUPER_TEST (ID) VALUES (2);
INSERT INTO SUPER_TEST (ID) VALUES (3);
INSERT INTO SUPER_TEST (ID) VALUES (4);
INSERT INTO SUPER_TEST (ID) VALUES (5);

INSERT INTO CHILD_TEST (ID) VALUES (1);
INSERT INTO CHILD_TEST (ID) VALUES (2);
INSERT INTO CHILD_TEST (ID) VALUES (3);
INSERT INTO CHILD_TEST (ID) VALUES (4);
INSERT INTO CHILD_TEST (ID) VALUES (5);


INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (1, 'ACTIVE', 'TEST@TEST.COM', 'SITE1', 'TYPE1');
INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (2, 'ACTIVE', 'TEST@TEST.COM', 'SITE2', 'TYPE1');
INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (3, 'ACTIVE', 'TEST@TEST.COM', 'SITE3', 'TYPE2');
INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (4, 'ACTIVE', 'TEST@TEST.COM', 'SITE4', 'TYPE2');
INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (5, 'ACTIVE', 'TEST@TEST.COM', 'SITE5', 'TYPE2');


INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (1,'GROUP1','COMMENT');
INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (2,'GROUP2','COMMENT');
INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (3,'GROUP3','COMMENT');
INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (4,'GROUP4','COMMENT');
INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (5,'GRPUP5','COMMENT');


INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (1,'ACTIVE',1, '123', 'STATUS', 'COMMENT', 'Specimen1', '2011-11-11 00:00:00', 1, 1);
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (2,'ACTIVE',2, '123', 'STATUS', 'COMMENT', 'Specimen1', '2011-11-11 00:00:00', 1, 1);
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (3,'ACTIVE',3, '123', 'STATUS', 'COMMENT', 'Specimen1', '2011-11-11 00:00:00', 1, 2);
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (4,'ACTIVE',3, '123', 'STATUS', 'COMMENT', 'Specimen1', '2011-11-11 00:00:00', 1, 2);
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (5,'ACTIVE',10, '123', 'STATUS', 'COMMENT', 'Specimen1', '2011-11-11 00:00:00', 1, 2);
...
INSERT INTO all_validation_type (ID, EMAIL, FUTURE, LENGTH, MAX_NUMERIC, PAST, MAX_STRING, MIN_NUMERIC, MIN_STRING, NOT_EMPTY, NOT_NULL, RANGE_STRING, RANGE_NUMERIC, PATTERN) VALUES (1, 'name@mail.nih.gov', '2008-05-15 00:00:00', '123', 999.0, '2008-05-15 00:00:00', '999', 1.0, '1', 'abc', 'abc', '3', 3.0, 'cat');
...
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (2, 'Two', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (3, 'Three', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (4, 'Four', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (5, 'Five', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (6, 'Six', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (7, 'Seven', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (8, 'Eight', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (9, 'Nine', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (10, 'Ten', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (11, 'Jack', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (12, 'Queen', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (13, 'King', 1, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (14, 'Ace', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (15, 'Two', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (16, 'Three', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (17, 'Four', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (18, 'Five', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (19, 'Six', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (20, 'Seven', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (21, 'Eight', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (22, 'Nine', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (23, 'Ten', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (24, 'Jack', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (25, 'Queen', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (26, 'King', 2, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (27, 'Ace', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (28, 'Two', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (29, 'Three', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (30, 'Four', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (31, 'Five', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (32, 'Six', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (33, 'Seven', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (34, 'Eight', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (35, 'Nine', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (36, 'Ten', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (37, 'Jack', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (38, 'Queen', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (39, 'King', 3, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (40, 'Ace', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (41, 'Two', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (42, 'Three', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (43, 'Four', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (44, 'Five', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (45, 'Six', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (46, 'Seven', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (47, 'Eight', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (48, 'Nine', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (49, 'Ten', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (50, 'Jack', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (51, 'Queen', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (52, 'King', 4, 'TEST');
INSERT INTO card (ID, NAME, SUIT_ID, IMAGE) VALUES (53, 'Joker', NULL, 'TEST');
