...
ALTER TABLE ONLY SUPER_TEST ADD CONSTRAINT PK_SUPER_TEST PRIMARY KEY (ID);
...
ALTER TABLE ONLY CHILD_TEST ADD CONSTRAINT PK_CHILD_TEST PRIMARY KEY (ID);
...
ALTER TABLE ONLY SITE ADD CONSTRAINT PK_SITE PRIMARY KEY (ID);
...
ALTER TABLE ONLY SPECIMEN_COLLECTION_GROUP ADD CONSTRAINT PK_SPECIMEN_COLLECTION_GROUP PRIMARY KEY (ID);
...
CREATE TABLE SPECIMEN ( 
	...
	SPECIMEN_COLLECTION_GROUP_ID integer NOT NULL 
);

ALTER TABLE ONLY SPECIMEN ADD CONSTRAINT PK_SPECIMEN PRIMARY KEY (ID);
...
ALTER TABLE ONLY MEMBER_M2MBS ADD CONSTRAINT PK_MEMBER_M2MBS PRIMARY KEY (id);
...
INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (1, 'ACTIVE', NULL, 'SITE1', 'TYPE1');
INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (2, 'ACTIVE', NULL, 'SITE2', 'TYPE1');
INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (3, 'ACTIVE', NULL, 'SITE3', 'TYPE2');
INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (4, 'ACTIVE', NULL, 'SITE4', 'TYPE2');
INSERT INTO SITE (ID, ACTIVITY_STATUS, EMAIL_ADDRESS, NAME, TYPE) VALUES (5, 'ACTIVE', NULL, 'SITE5', 'TYPE2');


INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (1,'GROUP1',NULL);
INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (2,'GROUP2',NULL);
INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (3,'GROUP3',NULL);
INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (4,'GROUP4',NULL);
INSERT INTO SPECIMEN_COLLECTION_GROUP (ID, NAME, COMMENT_TEXT) VALUES (5,'GRPUP5',NULL);


INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (1,'ACTIVE',1, NULL, NULL, NULL, 'Specimen1', NULL, 1, 1);
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (2,'ACTIVE',2, NULL, NULL, NULL, 'Specimen1', NULL, 1, 1);
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (3,'ACTIVE',3, NULL, NULL, NULL, 'Specimen1', NULL, 1, 2);
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (4,'ACTIVE',3, NULL, NULL, NULL, 'Specimen1', NULL, 1, 2);
INSERT INTO SPECIMEN (ID, ACTIVITY_STATUS, AVAILABLE_QTY, BARCODE, COLLECTION_STATUS, COMMENT_TEXT, LABEL, CREATED_ON, IS_AVAILABLE, SPECIMEN_COLLECTION_GROUP_ID) VALUES (5,'ACTIVE',10, NULL, NULL, NULL, 'Specimen1', NULL, 1, 2);
...
INSERT INTO long_primitive_key (ID, NAME) VALUES (987654321234568000, 'Long_Primitive_Key_NAME 987654321234567890');
