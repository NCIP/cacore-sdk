...
INSERT INTO `CSM_USER` (`USER_ID`,`LOGIN_NAME`,`FIRST_NAME`,`LAST_NAME`,`ORGANIZATION`,`department`,`TITLE`,`PHONE_NUMBER`,`PASSWORD`,`EMAIL_ID`,`START_DATE`,`END_DATE`,`UPDATE_DATE`) VALUES 
 ...
 ('13','/O=caBIG/OU=caGrid/OU=Training/OU=Dorian/CN=SDKUser1','user1','junit',NULL,NULL,NULL,NULL,'/3+jJvECOxQI2TxoU2+Xvw==',NULL,NULL,NULL,'2008-06-30 00:00:00'),
 ('14','/O=caBIG/OU=caGrid/OU=Training/OU=Dorian/CN=SDKUser2','user2','junit',NULL,NULL,NULL,NULL,'/3+jJvECOxQI2TxoU2+Xvw==',NULL,NULL,NULL,'2008-06-30 00:00:00');
COMMIT;
