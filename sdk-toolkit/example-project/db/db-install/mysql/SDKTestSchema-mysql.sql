...
SET AUTOCOMMIT=0;
INSERT INTO `SPECIMEN_COLLECTION_GROUP` (`ID`,`NAME`, `COMMENT`) VALUES 
 (1,'GROUP1',NULL),
 (2,'GROUP2',NULL),
 (3,'GROUP3',NULL),
 (4,'GROUP4',NULL),
...
CREATE TABLE `SPECIMEN` (
  ...
  `CREATED_ON` DATE,
  `IS_AVAILABLE` int(8),
  `SPECIMEN_COLLECTION_GROUP_ID` int(8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
SET AUTOCOMMIT=0;
INSERT INTO `SPECIMEN` (`ID`,`ACTIVITY_STATUS`, `AVAILABLE_QTY`, `BARCODE`,`COLLECTION_STATUS`,`COMMENT`, `LABEL`, `CREATED_ON`, `IS_AVAILABLE`, `SPECIMEN_COLLECTION_GROUP_ID`) VALUES 
