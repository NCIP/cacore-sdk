...
public class StringPrimitiveKeyResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "StringPrimitiveKey  RESTful Resource Test Case";
	}
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		File myFile = new File("StringPrimitiveKey"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("StringPrimitiveKey"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
