...
public class NoIdKeyResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "NoIdKey  RESTful Resource Test Case";
	}
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/NoIdKey";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("NoIdKey"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("NoIdKey"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
