...
public class BankResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Bank  RESTful Resource Test Case";
	}
