...
public class SpecimenResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Specimen  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Specimen obj = (Specimen) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Specimen/"+id;
