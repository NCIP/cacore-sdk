...
public class ProjectResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Project  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Project obj = (Project) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Project/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("Project"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Project/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetEmployeeCollection()
	{
		...
		{
		Project searchObject = new Project();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.manytomany.bidirectional.Project",searchObject );
		String id = "";
		
		if(results4 != null && results4.size() > 0)
		{
			Project obj = (Project) ((List)results4).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/Project/"+id+"/employeeCollection";
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Project";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("Project"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("Project"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
