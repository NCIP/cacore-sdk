...
public class PvtOrganizationResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "PvtOrganization  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			PvtOrganization obj = (PvtOrganization) ((List)results).get(0);
		...
		String url = baseURL + "/rest/PvtOrganization/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("PvtOrganization"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/PvtOrganization/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("PvtOrganization_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/PvtOrganization";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("PvtOrganization"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("PvtOrganization"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
