...
public class DisplayResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Display  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Display obj = (Display) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Display/"+id;
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		DefaultHttpClient httpClient = new DefaultHttpClient();
		String url = baseURL + "/rest/Display/search;id=*";
		HttpGet getRequest = new HttpGet(url);
		getRequest.addHeader("accept", "application/xml");
		...
		if (response.getStatusLine().getStatusCode() == Status.NOT_FOUND) {
 		...
 		File myFile = new File("Display_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
