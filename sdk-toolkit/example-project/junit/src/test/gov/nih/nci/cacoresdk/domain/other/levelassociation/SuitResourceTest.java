...
public class SuitResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Suit  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Suit obj = (Suit) ((List)results).get(0);
...
//***************************************************
	...
	public void testgetCardCollection()
	{
		...
		{
		Suit searchObject = new Suit();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.other.levelassociation.Suit",searchObject );
		String id = "";
		
		if(results4 != null && results4.size() > 0)
		{
			Suit obj = (Suit) ((List)results4).get(0);
	...
	public void testgetDeck()
	{
		...
		{
		Suit searchObject = new Suit();
 		Collection results5 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.other.levelassociation.Suit",searchObject );
		String id = "";
		
		if(results5 != null && results5.size() > 0)
		{
			Suit obj = (Suit) ((List)results5).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/Suit/"+id+"/deck";
			WebClient client = WebClient.create(url);
			client.type("application/xml").accept("application/xml");		
			Response response = client.get();
