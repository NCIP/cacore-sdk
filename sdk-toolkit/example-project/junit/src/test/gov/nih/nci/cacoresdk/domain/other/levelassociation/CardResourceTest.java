...
public class CardResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Card  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Card obj = (Card) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Card/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("Card"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Card/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetSuit()
	{
		...
		{
		Card searchObject = new Card();
 		Collection results5 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.other.levelassociation.Card",searchObject );
		String id = "";
		
		if(results5 != null && results5.size() > 0)
		{
			Card obj = (Card) ((List)results5).get(0);
