...
public class HardTopResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "HardTop  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			HardTop obj = (HardTop) ((List)results).get(0);
		...
		String url = baseURL + "/rest/HardTop/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("HardTop"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/HardTop/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetWheel()
	{
		...
		{
		HardTop searchObject = new HardTop();
 		Collection results5 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.inheritance.parentwithassociation.sametable.HardTop",searchObject );
		String id = "";
		
		if(results5 != null && results5.size() > 0)
		{
			HardTop obj = (HardTop) ((List)results5).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/HardTop/"+id+"/wheel";
			WebClient client = WebClient.create(url);
			client.type("application/xml").accept("application/xml");		
			Response response = client.get();
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/HardTop";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("HardTop"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("HardTop"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
