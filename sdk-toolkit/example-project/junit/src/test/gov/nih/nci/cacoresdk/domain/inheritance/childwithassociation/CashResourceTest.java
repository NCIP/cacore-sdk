...
public class CashResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Cash  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Cash obj = (Cash) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Cash/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("Cash"+"XML.xml");	
