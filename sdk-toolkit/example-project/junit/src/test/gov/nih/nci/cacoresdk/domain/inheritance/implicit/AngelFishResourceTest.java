...
public class AngelFishResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "AngelFish  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			AngelFish obj = (AngelFish) ((List)results).get(0);
		...
		String url = baseURL + "/rest/AngelFish/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("AngelFish"+"XML.xml");	
...
//***************************************************
	...
	public void testAngelFish1()
	{
		try
		{
	
		String url = baseURL + "/rest/AngelFish/search;id=*/tank";
	...
	public void testgetTank()
	{
		...
		{
		AngelFish searchObject = new AngelFish();
 		Collection results5 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.inheritance.implicit.AngelFish",searchObject );
		String id = "";
		
		if(results5 != null && results5.size() > 0)
		{
			AngelFish obj = (AngelFish) ((List)results5).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/AngelFish/"+id+"/tank";
			WebClient client = WebClient.create(url);
			client.type("application/xml").accept("application/xml");		
			Response response = client.get();
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/AngelFish";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("AngelFish"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("AngelFish"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
