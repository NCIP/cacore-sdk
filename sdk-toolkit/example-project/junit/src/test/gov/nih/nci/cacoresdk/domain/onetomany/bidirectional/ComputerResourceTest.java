...
public class ComputerResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Computer  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Computer obj = (Computer) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Computer/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("Computer"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Computer/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetHardDriveCollection()
	{
		try
		{
		Computer searchObject = new Computer();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.onetomany.bidirectional.Computer",searchObject );
		String id = "";
		
		if(results4 != null && results4.size() > 0)
		{
			Computer obj = (Computer) ((List)results4).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/Computer/"+id+"/hardDriveCollection";
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Computer";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("Computer"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("Computer"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
