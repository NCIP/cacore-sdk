...
public class StringKeyResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "StringKey  RESTful Resource Test Case";
	}
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/StringKey";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("StringKey"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("StringKey"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
