...
public class GraphicCalculatorResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "GraphicCalculator  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			GraphicCalculator obj = (GraphicCalculator) ((List)results).get(0);
		...
		String url = baseURL + "/rest/GraphicCalculator/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("GraphicCalculator"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/GraphicCalculator/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("GraphicCalculator_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/GraphicCalculator";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("GraphicCalculator"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("GraphicCalculator"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
