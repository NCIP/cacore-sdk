...
public class SportsShoesResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "SportsShoes  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			SportsShoes obj = (SportsShoes) ((List)results).get(0);
		...
		String url = baseURL + "/rest/SportsShoes/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("SportsShoes"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/SportsShoes/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("SportsShoes_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/SportsShoes";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("SportsShoes"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("SportsShoes"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
