...
public class ChefResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Chef  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Chef obj = (Chef) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Chef/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("Chef"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Chef/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetRestaurant()
	{
		...
		{
		Chef searchObject = new Chef();
 		Collection results5 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.manytoone.unidirectional.Chef",searchObject );
		String id = "";
		
		if(results5 != null && results5.size() > 0)
		{
			Chef obj = (Chef) ((List)results5).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/Chef/"+id+"/restaurant";
			WebClient client = WebClient.create(url);
			client.type("application/xml").accept("application/xml");		
			Response response = client.get();
