...
public class MemberO2OUSResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "MemberO2OUS  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			MemberO2OUS obj = (MemberO2OUS) ((List)results).get(0);
		...
		String url = baseURL + "/rest/MemberO2OUS/"+id;
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/MemberO2OUS/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("MemberO2OUS_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//***************************************************
	...
	public void testMemberO2OUS1()
	{
		try
		{
	
		String url = baseURL + "/rest/MemberO2OUS/search;id=*/mentor";
	...
	public void testgetMentor()
	{
		...
		{
		MemberO2OUS searchObject = new MemberO2OUS();
 		Collection results5 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.onetoone.unidirectional.selfassociation.MemberO2OUS",searchObject );
		String id = "";
		
		if(results5 != null && results5.size() > 0)
		{
			MemberO2OUS obj = (MemberO2OUS) ((List)results5).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/MemberO2OUS/"+id+"/mentor";
			WebClient client = WebClient.create(url);
			client.type("application/xml").accept("application/xml");		
			Response response = client.get();
