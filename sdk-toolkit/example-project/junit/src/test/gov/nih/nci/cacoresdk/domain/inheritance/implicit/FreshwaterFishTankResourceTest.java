...
public class FreshwaterFishTankResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "FreshwaterFishTank  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			FreshwaterFishTank obj = (FreshwaterFishTank) ((List)results).get(0);
		...
		String url = baseURL + "/rest/FreshwaterFishTank/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("FreshwaterFishTank"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/FreshwaterFishTank/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("FreshwaterFishTank_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/FreshwaterFishTank";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("FreshwaterFishTank"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("FreshwaterFishTank"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
