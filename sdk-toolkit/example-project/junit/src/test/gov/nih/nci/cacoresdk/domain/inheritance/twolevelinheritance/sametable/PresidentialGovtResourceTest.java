...
public class PresidentialGovtResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "PresidentialGovt  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			PresidentialGovt obj = (PresidentialGovt) ((List)results).get(0);
		...
		String url = baseURL + "/rest/PresidentialGovt/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("PresidentialGovt"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/PresidentialGovt/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("PresidentialGovt_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/PresidentialGovt";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("PresidentialGovt"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("PresidentialGovt"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
