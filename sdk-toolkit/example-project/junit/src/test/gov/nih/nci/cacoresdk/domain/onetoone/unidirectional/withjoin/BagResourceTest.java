...
public class BagResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Bag  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Bag obj = (Bag) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Bag/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("Bag"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Bag/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("Bag_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//***************************************************
	...
	public void testBag1()
	{
		...
		String url = baseURL + "/rest/Bag/search;id=*/handle";
	...
	public void testgetHandle()
	{
		...
		{
		Bag searchObject = new Bag();
 		Collection results5 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.onetoone.unidirectional.withjoin.Bag",searchObject );
		String id = "";
		
		if(results5 != null && results5.size() > 0)
		{
			Bag obj = (Bag) ((List)results5).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/Bag/"+id+"/handle";
			WebClient client = WebClient.create(url);
			client.type("application/xml").accept("application/xml");		
			Response response = client.get();
