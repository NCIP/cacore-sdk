...
public class SongResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Song  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Song obj = (Song) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Song/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("Song"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Song/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetAlbum()
	{
		...
		{
		Song searchObject = new Song();
 		Collection results5 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.manytoone.unidirectional.withjoin.Song",searchObject );
		String id = "";
		
		if(results5 != null && results5.size() > 0)
		{
			Song obj = (Song) ((List)results5).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/Song/"+id+"/album";
			WebClient client = WebClient.create(url);
			client.type("application/xml").accept("application/xml");		
			Response response = client.get();
