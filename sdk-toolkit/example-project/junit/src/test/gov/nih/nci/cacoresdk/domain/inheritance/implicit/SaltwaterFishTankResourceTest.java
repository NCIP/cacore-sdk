...
public class SaltwaterFishTankResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "SaltwaterFishTank  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			SaltwaterFishTank obj = (SaltwaterFishTank) ((List)results).get(0);
		...
		String url = baseURL + "/rest/SaltwaterFishTank/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("SaltwaterFishTank"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/SaltwaterFishTank/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetSubstrateCollection()
	{
		try
		{
		SaltwaterFishTank searchObject = new SaltwaterFishTank();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.inheritance.implicit.SaltwaterFishTank",searchObject );
		String id = "";
		
		if(results4 != null && results4.size() > 0)
		{
			SaltwaterFishTank obj = (SaltwaterFishTank) ((List)results4).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/SaltwaterFishTank/"+id+"/substrateCollection";
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/SaltwaterFishTank";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("SaltwaterFishTank"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("SaltwaterFishTank"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
