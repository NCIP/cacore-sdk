...
public class GovtOrganizationResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "GovtOrganization  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			GovtOrganization obj = (GovtOrganization) ((List)results).get(0);
		...
		String url = baseURL + "/rest/GovtOrganization/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("GovtOrganization"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/GovtOrganization/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("GovtOrganization_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/GovtOrganization";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("GovtOrganization"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("GovtOrganization"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
