...
public class BookResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Book  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Book obj = (Book) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Book/"+id;
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Book/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetAuthorCollection()
	{
		try
		{
		Book searchObject = new Book();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.manytomany.unidirectional.Book",searchObject );
		String id = "";
		
		if(results4 != null && results4.size() > 0)
		{
			Book obj = (Book) ((List)results4).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/Book/"+id+"/authorCollection";
