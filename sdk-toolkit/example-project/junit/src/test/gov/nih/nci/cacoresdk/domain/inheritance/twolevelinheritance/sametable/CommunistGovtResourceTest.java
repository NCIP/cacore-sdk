...
public class CommunistGovtResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "CommunistGovt  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			CommunistGovt obj = (CommunistGovt) ((List)results).get(0);
		...
		String url = baseURL + "/rest/CommunistGovt/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("CommunistGovt"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/CommunistGovt/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("CommunistGovt_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/CommunistGovt";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("CommunistGovt"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("CommunistGovt"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
