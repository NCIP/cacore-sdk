...
public class DemocraticGovtResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "DemocraticGovt  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			DemocraticGovt obj = (DemocraticGovt) ((List)results).get(0);
		...
		String url = baseURL + "/rest/DemocraticGovt/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("DemocraticGovt"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/DemocraticGovt/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("DemocraticGovt_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/DemocraticGovt";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("DemocraticGovt"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("DemocraticGovt"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
