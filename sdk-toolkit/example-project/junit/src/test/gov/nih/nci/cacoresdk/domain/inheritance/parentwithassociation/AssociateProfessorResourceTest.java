...
public class AssociateProfessorResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "AssociateProfessor  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			AssociateProfessor obj = (AssociateProfessor) ((List)results).get(0);
		...
		String url = baseURL + "/rest/AssociateProfessor/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("AssociateProfessor"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/AssociateProfessor/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetAssistantCollection()
	{
		...
		{
		AssociateProfessor searchObject = new AssociateProfessor();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.inheritance.parentwithassociation.AssociateProfessor",searchObject );
		String id = "";
		
		if(results4 != null && results4.size() > 0)
		{
			AssociateProfessor obj = (AssociateProfessor) ((List)results4).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/AssociateProfessor/"+id+"/assistantCollection";
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/AssociateProfessor";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("AssociateProfessor"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("AssociateProfessor"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
