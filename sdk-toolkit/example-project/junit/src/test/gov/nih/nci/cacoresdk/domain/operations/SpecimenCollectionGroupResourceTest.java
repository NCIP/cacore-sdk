...
public class SpecimenCollectionGroupResourceTest extends SDKRESTfulTestBase
{
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
 		...
 		Collection results = getApplicationService().search("gov.nih.nci.cacoresdk.domain.operations.SpecimenCollectionGroup",searchObject );
		String id = "";
...
//***************************************************
	...
	public void testgetSpecimenCollection()
	{
		...
		{
		SpecimenCollectionGroup searchObject = new SpecimenCollectionGroup();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.operations.SpecimenCollectionGroup",searchObject );
		String id = "";
