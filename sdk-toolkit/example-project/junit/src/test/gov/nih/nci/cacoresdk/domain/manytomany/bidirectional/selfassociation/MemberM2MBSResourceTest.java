...
public class MemberM2MBSResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "MemberM2MBS  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			MemberM2MBS obj = (MemberM2MBS) ((List)results).get(0);
		...
		String url = baseURL + "/rest/MemberM2MBS/"+id;
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/MemberM2MBS/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("MemberM2MBS_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//***************************************************
	...
	public void testMemberM2MBS1()
	{
		try
		{
	
		String url = baseURL + "/rest/MemberM2MBS/search;id=*/mentorCollection";
	...
	public void testgetMentorCollection()
	{
		...
		{
		MemberM2MBS searchObject = new MemberM2MBS();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.manytomany.bidirectional.selfassociation.MemberM2MBS",searchObject );
		String id = "";
		
		if(results4 != null && results4.size() > 0)
		{
			MemberM2MBS obj = (MemberM2MBS) ((List)results4).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/MemberM2MBS/"+id+"/mentorCollection";
	...
	public void testMemberM2MBS2()
	{
		try
		{
	
		String url = baseURL + "/rest/MemberM2MBS/search;id=*/memberCollection";
	...
	public void testgetMemberCollection()
	{
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/MemberM2MBS/"+id+"/memberCollection";
