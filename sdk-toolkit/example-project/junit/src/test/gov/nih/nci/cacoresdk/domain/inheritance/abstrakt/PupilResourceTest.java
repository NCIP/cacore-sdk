...
public class PupilResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Pupil  RESTful Resource Test Case";
	}
