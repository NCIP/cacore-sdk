...
public class ProfessorResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Professor  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Professor obj = (Professor) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Professor/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("Professor"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Professor/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
...
//***************************************************
	...
	public void testgetAssistantCollection()
	{
		...
		{
		Professor searchObject = new Professor();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.inheritance.parentwithassociation.Professor",searchObject );
		String id = "";
		
		if(results4 != null && results4.size() > 0)
		{
			Professor obj = (Professor) ((List)results4).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/Professor/"+id+"/assistantCollection";
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Professor";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("Professor"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("Professor"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
