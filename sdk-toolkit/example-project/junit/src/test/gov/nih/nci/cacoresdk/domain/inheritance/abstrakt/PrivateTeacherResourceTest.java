...
public class PrivateTeacherResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "PrivateTeacher  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			PrivateTeacher obj = (PrivateTeacher) ((List)results).get(0);
		...
		String url = baseURL + "/rest/PrivateTeacher/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("PrivateTeacher"+"XML.xml");	
...
//***************************************************
	...
	public void testPrivateTeacher1()
	{
		try
		{
	
		String url = baseURL + "/rest/PrivateTeacher/search;id=*/pupilCollection";
	...
	public void testgetPupilCollection()
	{
		try
		{
		PrivateTeacher searchObject = new PrivateTeacher();
 		Collection results4 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.inheritance.abstrakt.PrivateTeacher",searchObject );
		String id = "";
		
		if(results4 != null && results4.size() > 0)
		{
			PrivateTeacher obj = (PrivateTeacher) ((List)results4).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/PrivateTeacher/"+id+"/pupilCollection";
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/PrivateTeacher";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("PrivateTeacher"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("PrivateTeacher"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
