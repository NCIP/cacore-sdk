...
public class FinancialCalculatorResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "FinancialCalculator  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			FinancialCalculator obj = (FinancialCalculator) ((List)results).get(0);
		...
		String url = baseURL + "/rest/FinancialCalculator/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("FinancialCalculator"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/FinancialCalculator/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("FinancialCalculator_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/FinancialCalculator";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("FinancialCalculator"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("FinancialCalculator"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
