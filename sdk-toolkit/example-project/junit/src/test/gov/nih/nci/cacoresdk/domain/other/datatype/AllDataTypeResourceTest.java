...
public class AllDataTypeResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "AllDataType  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			AllDataType obj = (AllDataType) ((List)results).get(0);
		...
		String url = baseURL + "/rest/AllDataType/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("AllDataType"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/AllDataType/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("AllDataType_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/AllDataType";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("AllDataType"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("AllDataType"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
