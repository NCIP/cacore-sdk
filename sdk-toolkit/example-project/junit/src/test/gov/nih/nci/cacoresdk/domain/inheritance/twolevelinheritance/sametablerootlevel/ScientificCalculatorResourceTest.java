...
public class ScientificCalculatorResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "ScientificCalculator  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			ScientificCalculator obj = (ScientificCalculator) ((List)results).get(0);
		...
		String url = baseURL + "/rest/ScientificCalculator/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("ScientificCalculator"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/ScientificCalculator/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("ScientificCalculator_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/ScientificCalculator";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("ScientificCalculator"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("ScientificCalculator"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
