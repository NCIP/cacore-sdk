...
public class CalculatorResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Calculator  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Calculator obj = (Calculator) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Calculator/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("Calculator"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Calculator/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("Calculator_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Calculator";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("Calculator"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("Calculator"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
