...
public class UndergraduateStudentResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "UndergraduateStudent  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			UndergraduateStudent obj = (UndergraduateStudent) ((List)results).get(0);
		...
		String url = baseURL + "/rest/UndergraduateStudent/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("UndergraduateStudent"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/UndergraduateStudent/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("UndergraduateStudent_Search"+"XML.xml");						
		System.out.println("writing data to file "+myFile.getAbsolutePath());
		FileWriter myWriter = new FileWriter(myFile);
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/UndergraduateStudent";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("UndergraduateStudent"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("UndergraduateStudent"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
