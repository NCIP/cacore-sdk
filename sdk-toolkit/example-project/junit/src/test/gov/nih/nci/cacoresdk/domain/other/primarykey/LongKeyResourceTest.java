...
public class LongKeyResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "LongKey  RESTful Resource Test Case";
	}
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/LongKey";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("LongKey"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("LongKey"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
