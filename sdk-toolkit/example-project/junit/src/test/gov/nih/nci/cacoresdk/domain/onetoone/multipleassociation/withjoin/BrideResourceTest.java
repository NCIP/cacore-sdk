...
public class BrideResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "Bride  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			Bride obj = (Bride) ((List)results).get(0);
		...
		String url = baseURL + "/rest/Bride/"+id;
		...
		if (response.getStatus() == Status.NOT_FOUND.getStatusCode()) {
 		...
 		File myFile = new File("Bride"+"XML.xml");	
	...
	public void testSearch() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/Bride/search;id=*";
		WebClient client = WebClient.create(url);
		client.type("application/xml").accept("application/xml");		
		Response response = client.get();
