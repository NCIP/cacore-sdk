...
public class ChildTestResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "ChildTest  RESTful Resource Test Case";
	}
	...
	public void testGet() throws ApplicationException
	{
	  ...
	  try {
		...
		{
			ChildTest obj = (ChildTest) ((List)results).get(0);
		...
		String url = baseURL + "/rest/ChildTest/"+id;
