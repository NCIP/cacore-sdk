...
public class AllValidationTypeResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "AllValidationType  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
 		...
 		Collection results = getApplicationService().search("gov.nih.nci.cacoresdk.domain.other.validationtype.AllValidationType",searchObject );
		String id = "";
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/AllValidationType";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("AllValidationType"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("AllValidationType"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
