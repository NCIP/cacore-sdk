...
public class DiscusFishResourceTest extends SDKRESTfulTestBase
{
	public static String getTestCaseName()
	{
		return "DiscusFish  RESTful Resource Test Case";
	}
	...
	public void testGet() throws Exception
	{
	  ...
	  try {
		...
		{
			DiscusFish obj = (DiscusFish) ((List)results).get(0);
		...
		String url = baseURL + "/rest/DiscusFish/"+id;
		...
		if (response.getStatus() == Status.NOT_ACCEPTABLE.getStatusCode()) {
 		...
 		File myFile = new File("DiscusFish"+"XML.xml");	
...
//***************************************************
	...
	public void testDiscusFish1()
	{
		try
		{
	
		String url = baseURL + "/rest/DiscusFish/search;id=*/tank";
	...
	public void testgetTank()
	{
		...
		{
		DiscusFish searchObject = new DiscusFish();
 		Collection results5 = getApplicationService().search("gov.nih.nci.cacoresdk.domain.inheritance.implicit.DiscusFish",searchObject );
		String id = "";
		
		if(results5 != null && results5.size() > 0)
		{
			DiscusFish obj = (DiscusFish) ((List)results5).get(0);
		...
		if(id.equals(""))
			...
			String url = baseURL + "/rest/DiscusFish/"+id+"/tank";
			WebClient client = WebClient.create(url);
			client.type("application/xml").accept("application/xml");		
			Response response = client.get();
...
//********************************************************End
	...
	public void testPost() throws Exception
	{
	  ...
	  try {
		...
		String url = baseURL + "/rest/DiscusFish";
		WebClient client = WebClient.create(url);
		...
		File myFile = new File("DiscusFish"+"XML.xml");						
 		...
 		{
 			testGet();
 			myFile = new File("DiscusFish"+"XML.xml");
 			if(!myFile.exists())
				return;
 		}
