...
if(className != null)
{
	...
	{	
		...
		idColumn = jspUtils.getClassIdName(className);
		autoId = jspUtils.getAutoGeneratedId();
		idColumnType = jspUtils.getDataType(className, idColumn);
...
%>
		...
		<tr align="left" valign="top">
			...
			<%if(autoId && (idColumnType.equals("java.lang.Long") || idColumnType.equals("java.lang.Integer") ||idColumnType.equals("java.lang.Short"))){%>
				Auto generated
			<%} else if(autoId){ %>
				Invalid auto generation setting for type <%=idColumnType%>. Data can not be saved.
			<%} else { 
			%>
...
%>
		...
		<tr align="left" valign="top">
			...
			<td class="formField" width="90%">
				<%=HtmlUtils.getHtmlFor(filedName,idType)%> <%=note%>
			</td>
		</tr>			
			<% }
			}
