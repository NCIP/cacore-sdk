...
//		}
    ...
    public Map<String,String> getPropsMap(){
		...
		if (serverType.equalsIgnoreCase(TOMCAT)){
			...
			propsMap.put("exclude.jboss.backup", "true");
			propsMap.put("jboss.ssl.enable", "false");
			propsMap.put("jboss.java.opts", "-server -Xms512m -Xmx1024m -XX:ThreadStackSize=128 -XX:SurvivorRatio=10 -XX:PermSize=128m -XX:MaxPermSize=256m -Dsun.rmi.dgc.client.gcInterval=3600000 -Dsun.rmi.dgc.server.gcInterval=3600000 -Djava.awt.headless=true");
			propsMap.put("jboss.external.http.host", "");
			propsMap.put("jboss.external.http.port", "");
			propsMap.put("jboss.external.ssl.host", "");
			propsMap.put("jboss.external.ssl.port", "");
			propsMap.put("jboss.web.user", "bda");
			propsMap.put("exclude.jboss-login-config", "true");
			propsMap.put("jboss.web.password", "blueprint123!");
		}
