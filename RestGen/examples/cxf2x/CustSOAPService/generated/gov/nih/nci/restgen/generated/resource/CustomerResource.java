...
public class CustomerResource
{
	...
	@GET
		@Path("/customers")
		@Produces("application/xml")
		public java.util.List<gov.nih.nci.restgen.generated.client.Customer> getCustomer3( @Context UriInfo uriInfo)
		{
			try
			{
	...
	@GET
		@Path("/ByName/{name}")
		@Produces("application/xml")
		public gov.nih.nci.restgen.generated.client.Customer getCustomer4(@PathParam("name") java.lang.String name, @Context UriInfo uriInfo)
		{
			try
			{
				List<PathSegment> pathSegments = uriInfo.getPathSegments();
			...
			{
				 e.printStackTrace();
				 throw new WebApplicationException(buildResponseError("GET_METHOD", "Customer", "Customer4", "Failed to process GET method"+ e.toString()).build());
			}
			catch(WebApplicationException e)
			{
				e.printStackTrace();
