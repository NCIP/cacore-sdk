...
public class RESTfulWebResourceGenerator extends Generator {
	...
	public void runProcess() throws GeneratorException {
		...
		for (Resource resource : resources) {
			String beanDefStr = "<bean id=\""+resource.getName()+"\" class=\"gov.nih.nci.restgen.generated.resource."+resource.getName()+"Resource\" />";
			template.setAttribute(
					"ResourceRefBeanDef", beanDefStr);
			String refBean = "<ref bean=\""+resource.getName()+"\" />";
			template.setAttribute(
					"ResourceRefBean", refBean);
		...
		if(mapping.getOptions().getWsdlLocation() != null)
		{
			...
			Description desc = reader.read(new URL(mapping.getOptions().getWsdlLocation()));
			...
			for (Schema schema : schemas) {
				...
				{
				String value = "<value>gov.nih.nci.restgen.generated.client."+cType.getName()+"</value>";
				template.setAttribute(
						"ResourcePojo", value);
				}
		...
		*/
		if(mapping.getOptions().getWsdlLocation() != null)
		{
			...
			for (Schema schema : schemas) {
				...
				for(ComplexType cType: complexTypes)
				{
				String value = "<value>gov.nih.nci.restgen.generated.client."+getUpperCaseStart(cType.getName())+"</value>";
				template.setAttribute(
						"ResourcePojo", value);
				}
