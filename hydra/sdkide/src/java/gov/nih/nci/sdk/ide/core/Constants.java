...
public class Constants {
	...
	public static String[] categories = {"Meaning", "Persistence", "Security", "Validation", "Presentation", "Representation", "Service"};
	
	public static String[] meaningTabs = {"Domain", "Properties", "Operations", "Relationships"};
	public static String[] persistenceTabs = {"Domain", "Properties"};
}
